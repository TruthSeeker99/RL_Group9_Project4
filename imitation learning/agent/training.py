...
def main(cfg_file):
    ...
    if model_checkpoint == "0":
        ...
        agent = PPO("MultiInputPolicy", env, verbose=1,
                    ...
                    tensorboard_log=tensor_board_folder, stats_window_size=10)
    else:
    ...
    auto_save_callback = AutoSave(check_freq=100000, num_envs=num_envs,
                                  save_path=f"models/{run.id}", filename_prefix=model_checkpoint + "_")
    ...
    agent.learn(total_timesteps=time_steps, callback=callback)
