...
def main(all_settings):
    ...
    # last_model_checkpoint = model_checkpoint + '_last'
    # last_model_path = os.path.join(model_folder, last_model_checkpoint)
    # print('>>>here:', last_model_path)
    # if os.path.exists(last_model_checkpoint + '.zip'):
    #     print('>>>load_last_model')
    #     agent.load(last_model_path)

    # last_model_path = './ckpts/PPO_last.zip'
    # print('>>>load_last_model')
    # agent.load(last_model_path)
